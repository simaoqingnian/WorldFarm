...
BLEND_PATH = SCRIPT_DIR / "carrot_normal_v001_reference_r06.blend"
FBX_PATH = EXPORT_DIR / "Crop_Carrot_Normal_v001_reference_r06.fbx"
...
def body_radius(t):
    return profile_lerp(BODY_PROFILE, t)
...
def create_reference_body(material):
    ...
    mesh = bpy.data.meshes.new("Mesh_Carrot_Normal_v001_ReferenceBody_r06")
    ...
    body = bpy.data.objects.new("Crop_Carrot_Normal_v001_Body_Reference_r06", mesh)
...
def create_leaf_cluster(leaf_material, leaf_light_material, leaf_dark_material):
    ...
    add_uv_sphere(
        "LeafStem_CoreBase_Reference_r06",
...
def create_reference_surface_marks(groove_material, groove_light_material, highlight_material):
    create_surface_ribbon("CarrotSoftGroove_Upper_Reference_r06", 0.610, -0.185, 0.235, 0.014, -23.0, groove_material, -0.002, 0.002)
    create_surface_ribbon("CarrotSoftGroove_UpperLight_Reference_r06", 0.615, -0.192, 0.155, 0.003, -23.0, groove_light_material, -0.006, 0.001)
    create_surface_ribbon("CarrotSoftGroove_Lower_Reference_r06", 0.450, -0.225, 0.215, 0.013, -21.0, groove_material, -0.002, 0.002)
    create_surface_ribbon("CarrotSoftGroove_LowerLight_Reference_r06", 0.455, -0.232, 0.145, 0.003, -21.0, groove_light_material, -0.006, 0.001)
...
def configure_scene():
    ...
    scene.world = bpy.data.worlds.new("WorldFarm_ReferenceCarrot_World_r06")
...
def main():
    ...
    body_material = make_material("Mat_Carrot_Reference_GlossyBody_r06", (1.00, 0.41, 0.030, 1.0), 0.40, 0.50)
    groove_material = make_material("Mat_Carrot_Reference_SoftGroove_r06", (0.90, 0.27, 0.015, 1.0), 0.50, 0.16)
    groove_light_material = make_material("Mat_Carrot_Reference_GrooveHighlight_r06", (1.00, 0.67, 0.150, 1.0), 0.44, 0.26)
    highlight_material = make_material("Mat_Carrot_Reference_PaintedHighlight_r06", (1.00, 0.72, 0.22, 1.0), 0.34, 0.46)
    leaf_material = make_material("Mat_Carrot_Reference_LeafGloss_r06", (0.30, 0.72, 0.105, 1.0), 0.40, 0.44)
    leaf_light_material = make_material("Mat_Carrot_Reference_LeafLight_r06", (0.54, 0.90, 0.18, 1.0), 0.38, 0.48)
    leaf_dark_material = make_material("Mat_Carrot_Reference_LeafDark_r06", (0.11, 0.43, 0.08, 1.0), 0.46, 0.34)
    ...
    render_view("v001_reference_r06_front.png", (0.0, -6.2, 1.34), (0.02, 0.0, 1.22), 2.72)
    render_view("v001_reference_r06_side.png", (6.0, 0.0, 1.36), (0.03, 0.0, 1.22), 2.72)
    render_view("v001_reference_r06_three_quarter.png", (4.5, -5.2, 1.72), (0.03, 0.0, 1.22), 2.82)
    render_view("v001_reference_r06_icon_angle.png", (-2.9, -6.4, 1.66), (0.02, 0.0, 1.22), 2.55, 31.0)
