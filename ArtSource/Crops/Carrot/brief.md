...
- 目标质感：明亮、温暖、适合手机农场游戏。
- 底部方向：钝圆收尾，不要尖锥；阶段 2 已通过并锁定。
- 禁止方向：顶部像碗、顶部像平台、底部尖锥、中段环形凸带、过高过瘦、棱角硬。
- 整体大形：短胖型，高度约为最大宽度的 `2.2` 倍。
...
| 编号 | 项目 | 状态 |
| --- | --- | --- |
| Q1 | 整体大形比例 | `confirmed: 1.A` |
| Q2 | 顶部叶簇覆盖方式 | `confirmed: 2.C` |
| Q3 | 侧面轮廓曲线 | `confirmed: 3.B` |
| Q4 | 正式灰模是否允许轻微不对称 | `confirmed: 4.B` |
| Q5 | 第一版是否先做单根成熟胡萝卜 | `confirmed: 5.A` |
